...
const cryptr = new Cryptr(process.env.SECRET_CRYPT || 'secret-puk-1234')
...
function _saveUsersToFile() {
    try {
        ...
        fs.writeFile('data/user.json', usersStr)
    } catch (error) {
        throw new Error(`Error saving users to file: ${error.message}`)
    }
}
// function _saveUsersToFile() {
